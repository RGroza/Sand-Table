...
class MotorThreads:
    ...
    def run_MLin(self, delay, step_size):
        ...
        M_Lin.turn_steps(Dir='forward', steps=10000, stepdelay=delay)
        sleep(0.1)
        M_Lin.turn_steps(Dir='backward', steps=10000, stepdelay=delay)
...
delays = [0.1, 0.001, 0.0005, 0.0001, 0.00005, 0.00001]
